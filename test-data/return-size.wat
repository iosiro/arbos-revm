;; Variable return size test program for arbos-revm
;; Protocol:
;;   Last 4 bytes of input (big-endian) = desired return data size
;; Returns: zero-filled data of the specified size
;;
;; Used to test large return data handling and memory growth
