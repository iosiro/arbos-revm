;; Memory growth test program for arbos-revm
;; Protocol:
;;   byte[0] = target memory size in pages
;;   byte[1] = step size for growth
;; Returns: 1 byte with final memory size
;;
;; Grows memory incrementally until reaching target size
