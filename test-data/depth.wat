...
;; Stack depth recursion test program for arbos-revm
;; Tests deep recursion and stack overflow behavior
;; Exports:
;;   depth (global) - Tracks recursion depth
;;   recurse(ignored) - Recursively calls itself, incrementing depth counter
